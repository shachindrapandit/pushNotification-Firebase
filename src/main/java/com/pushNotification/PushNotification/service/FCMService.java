...
import com.pushNotification.PushNotification.model.PushNotificationRequest;
...
public class FCMService {
    ...
    public void sendMessageWithoutData(PushNotificationRequest request) throws ExecutionException, InterruptedException {
        ...
        String response = sendAndGetResponse(message);
        logger.info("Sent message without data. Topic: " +
                request.getTopic() + " " + response);
    }
    ...
    public void sendMessageToToken(PushNotificationRequest request) throws ExecutionException, InterruptedException {
        ...
        logger.info("Sent message to token. Device token: " +
                request.getToken() + ", " + response + " msg " + jsonOutput);
    }
        ...
        return Message.builder()
                .setApnsConfig(apnsConfig).setAndroidConfig(androidConfig).
                        setNotification(Notification.builder().
                                build()).putData(request.getTitle(), request.getMessage());
    }
